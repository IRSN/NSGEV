...
Even if very small values of $\xi$ are not frequently used, it turns
out that the exact derivatives are difficult to evaluate for small
$\xi$, which may have some bad consequences in optimisations. This is
